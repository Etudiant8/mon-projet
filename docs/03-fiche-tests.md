...
- **Lien vers le run réussi** : https://github.com/Etudiant8/mon-projet/actions/runs/28567259282
- **Ce qui est testé** :
...
- **Résultat** : ✅ Tous les tests passés — run #14 confirmé vert sur GitHub Actions
